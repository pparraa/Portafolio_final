...
function newRowTable()
{
	...
	var variedadEspecie=document.getElementById("variedadEspecie").value;
	var kilos=document.getElementById("crearSolicitud-kilos").value;
	var precio=document.getElementById("crearSolicitud-precio").value;
    ...
    cell1.innerHTML = '<p name="especie_f[]" class="non-margin">'+especie+'</p>';
    cell2.innerHTML = '<p name="variedadEspecie_p[]" class="non-margin">'+variedadEspecie+'</p>';
    cell3.innerHTML = '<p name="kilos_p[]" class="non-margin">'+kilos+'</p>';
    cell4.innerHTML = '<p name="precio_p[]" class="non-margin">'+precio+'</p>';
    cell5.innerHTML = '<span class="icon fa-edit"></span><span class="icon fa-eraser"></span>';
